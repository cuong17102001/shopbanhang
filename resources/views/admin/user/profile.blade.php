        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-xlg-3 col-md-5">
                    <div class="card">
                        <div class="card-body">
                            <center class="m-t-30"> <img src="{{ asset('upload/admin/' . $profile->avatar) }}"
                ...
                <div class="col-lg-8 col-xlg-9 col-md-7">
                    <div class="card">
                        <div class="card-body">
                            @if (session('succsess'))
                                <div class="">
                                    <span style="color: green; font-size: 20px">{{ session('succsess') }}</span>
                                </div>
                            @endif
                            <form action="{{ URL::to('admin/update_profile') }}" class="form-horizontal form-material"
